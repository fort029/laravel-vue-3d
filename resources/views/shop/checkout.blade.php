            ...
            <div class="row g-md-8 mt-4">
                ...
                <div class="col-12 col-lg-6 col-xl-7">
                    ...
                    <div class="checkout-panel">
                      ...
                      <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                        <input class="form-check-input" type="radio" name="checkoutShippingMethod" id="checkoutShippingMethodThree" checked>
                        <label class="form-check-label" for="checkoutShippingMethodThree">
                          <span class="d-flex justify-content-between align-items-start">
                            ...
                            <span class="small fw-bolder text-uppercase">${{$shipping_total}}</span>
                          </span>
                        </label>
                      </div>
                    </div>
                ...
                <div class="col-12 col-lg-6 col-xl-5">
                    <div class="bg-light p-4 sticky-md-top top-5">
                            ...
                            <div class="d-none d-md-flex justify-content-between align-items-start py-2">
                                <div class="d-flex flex-grow-1 justify-content-start align-items-start">
                                    <div class="position-relative f-w-20 border p-2 me-4">
                                        <span class="checkout-item-qty">{{$row->qty}}</span>
                                        <img src="{{$row->options->img}}" alt="" class="rounded img-fluid">
                                    </div>
                                    <div>
                        ...
                        <div class="py-3 border-bottom">
                            ...
                            <div class="d-flex justify-content-between align-items-center ">
                                ...
                                <p class="m-0 fs-6 fw-bolder">${{$shipping_subtotal}}</p>
                            </div>
                        </div>
                        <div class="py-3 border-bottom">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="text-muted small">Inc ${{Cart::tax()+$shipping_tax}} sales tax</span>
                                </div>
                                <p class="m-0 fs-5 fw-bold">${{Cart::total()+$shipping_total}}</p>
                            </div>
                        </div>
                        <div class="py-3 border-bottom">
                    ...
                    <div class="form-group form-check my-4">
                        ...
                        <label class="form-check-label fw-bolder" for="accept-terms">I agree to Letris's <a href="#">terms & conditions</a></label>
                    </div>
