        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                <div class="col-md-7">
                    ...
                    <p class="lead">Real-time 3D modeling using objects from blender with the use of. Simple and fun thanks to Vue. For example, a visual presentation of truck loading.</p>
                </div>
                <div class="col-md-5">
                    <loading-planning></loading-planning>
                </div>
            ...
            <div class="row featurette">
                <div class="col-md-7 order-md-2">
                    ...
                    <p class="lead">A useful tool for dynamically presenting graphic elements. Possibility of interactive facility management. Easy implementation as a Vue component.</p>
                </div>
